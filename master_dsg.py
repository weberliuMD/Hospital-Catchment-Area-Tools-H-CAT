...
dsg.bing_batch_geocode("Admissions_data/HTD_Trim.csv")
# dsg.here_batch_geocode("Admissions_data/HTD_Trim.csv", endPos = 1000)
# dsg.tomtom_batch_geocode("Admissions_data/HTD_Trim.csv", endPos = 1000)